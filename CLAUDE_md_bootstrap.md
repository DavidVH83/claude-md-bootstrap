...
> **Note for the user:** The sections above (1–9) are project-specific and generated
> from your answers. After generating, append your personal universal sections
> (knowledge bank, tools, behaviour rules, local resources) from your own defaults
> template. These are not included here because they are personal to you.
